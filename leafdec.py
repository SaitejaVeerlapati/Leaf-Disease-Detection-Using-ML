...
def build_model():
    try:
        ...
        CATEGORIES = ['Tomato___Target_Spot', 'Tomato_mosaic_virus', 'Tomato_Yellow_Leaf_Curl_Virus', 'Tomato___Bacterial_spot', 'Tomato___Early_blight', 'Tomato___healthy', 'Tomato___Late_blight', 'Tomato___Leaf_Mold', 'Tomato___Septoria_leaf_spot', 'Tomato___Spider_mites']
        data = []
        clas = []
    ...
    model.add(Dense(1024)) model.add(Activation("relu"))
